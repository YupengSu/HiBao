...
hi_void IotPublishSample(void)
{
    ...
    WeChatProfile weChatProfile = {
        ...
        .reportAction.temperatureData = 50, /* 30 :temperature data */
        /* report humidity */
        .reportAction.subDeviceActionHumidity = "humidity",
        .reportAction.humidityActionData = 50, /* humidity data */
        /* report light_intensity */
        .reportAction.subDeviceActionLightIntensity = "light_intensity",
        .reportAction.lightIntensityActionData = 50, /* 60 : light_intensity */
        
        .reportAction.subDeviceActiontestData="test",
        .reportAction.testData=2,
    };
