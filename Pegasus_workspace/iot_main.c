...
static const char *gDefaultSubscribeTopic[] = {
    ...
    "4FFMYT2AVB/Hi3861_mqtt/data",
    "4FFMYT2AVB/Hi3861_mqtt/event",
    "4FFMYT2AVB/Hi3861_mqtt/control",
    "4FFMYT2AVB/Hi3861_mqtt/move",
};
...
static void MainEntryProcess(void)
{
    ...
    //使用 MQTTClient_create 函数创建 MQTT 客户端，并将返回的客户端对象存储在 client 中。
    ...
    //使用循环遍历订阅主题的数组，并使用 MQTTClient_subscribeMany 函数订阅这些主题
    ...
    //在 MQTT 客户端保持连接的情况下，执行 ProcessQueueMsg 函数来处理队列消息
